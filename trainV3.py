...
from unet import UNet, AttentionUNet  # 修改導入 AttentionUNet
...
def get_args():
    ...
    parser.add_argument('--val', '-v', type=float, default=15.0, help='Percent of the data that is used as validation (0-100)')
...
if __name__ == '__main__':
    ...
    # 創建模型，傳入 bilinear 參數
    model = AttentionUNet(n_channels=3, n_classes=5, bilinear=False)
